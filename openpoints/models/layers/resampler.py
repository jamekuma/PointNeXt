...
class Resampler(nn.Module):
    ...
    def update_loss(self, pos, new_pos_ds, delta_pos_ds, gamma=1):
        """_summary_
        ...
        cd_loss = self.__cd_loss(target_pos, new_pos_ds, gamma=gamma)
    ...
    def forward(self, pos, pos_ds):
        ...
        self.update_loss(pos, new_pos_ds, delta_pos_ds, gamma=self.gamma)
